...
#plt.plot(leDu_wavelength,np.log10(leDu_spectrum_absolute_smoothed),'-', color='#64a030',linewidth=2.0, label='LeDu scaled and smoothed')
...
#plt.plot(somme_wavelength,np.log10(somme_spectrum_absolute_smoothed),'m-',linewidth=2.0, label='Somme scaled and smoothed')
...
plt.plot(gtc_wavelength, np.log10(gtc_spectrum_absolute_dereddened), 'r-')
...
plt.plot(wiyn_wavelength, np.log10(wiyn_spectrum_absolute_dereddened), 'b-')
...
plotname = '/Users/azuri/daten/uni/HKU/Pa30/report/images/Pa30_WN+GTC_absolute_dereddened_R_V=%.1f_ebv=%.3f' % (R_V, ebv)
#plotname = '/Users/azuri/daten/uni/HKU/Pa30/report/images/Pa30_WN+GTC+Somme+LeDu_absolute_dereddened_R_V=%.1f_ebv=%.3f' % (R_V, ebv)
plotname = plotname.replace('.','_')+'.pdf'
