...
#{'FName': 'IPHAS_GTC_DATA/DATA4_2016A/GTC4-16AMEX/OB0035/gtc_object_av_x_wl_flt_cal.fits', 'ylim' : [0,0], 'OName': 'KnJ1857', 'SkyLeft':[1138,1179], 'SkyRight':[1392,1432], 'ObjectAreas':[[1221,1288],[1337,1374]]},#can't see lines just a possibly extended (compact) object in the center
...
#{'FName': 'IPHAS_GTC_DATA/DATA4_2016A/GTC4-16AMEX/OB0044/gtc_object_av_x_wl_flt_cal.fits', 'ylim' : [-2.0e-15,2.0e-15], 'OName': 'Alves1', 'SkyLeft':[1103,1140], 'SkyRight':[1474,1508], 'ObjectAreas':[[1170,1297],[1324,1471]]},#nothing, without central object
