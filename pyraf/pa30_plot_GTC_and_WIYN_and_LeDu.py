...
leDuSpectrum = boxCarMeanSmooth(leDu_spectrum, 0, 21)
sommeSpectrum = boxCarMeanSmooth(somme_spectrum, 0, 15)
...
plt.plot(leDu_wavelength,leDuSpectrum,'g-', label='PLeDu scaled and smoothed')
#plt.plot(somme_wavelength,somme_spectrum,'c-', label='Somme scaled')
...
#plt.title('Pa30')
plt.legend()
plotname = '/Users/azuri/daten/uni/HKU/Pa30/report/images/Pa30_WN+GTC+LeDu_'
if calibrated:
...
#plt.plot(leDu_wavelength,leDuSpectrum,'g-', label='LeDu scaled and smoothed')
